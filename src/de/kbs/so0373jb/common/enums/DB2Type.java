...
public enum DB2Type {
	...
	db2type_bigint, 	db2type_float, 		db2type_double,     db2type_decimal, 	db2type_char,
	db2type_varchar, 	db2type_xml, 		db2type_blob;
	...
	private static String[] java = 	{ "Date", 		"Time", 	"Timestamp", 	"Short",    	"Integer"
									...
									, "String", 	"String",	"byte[]" };
	private static String[] fx = 	{ "StringProperty", "StringProperty", "StringProperty", "IntegerProperty", "IntegerProperty"
