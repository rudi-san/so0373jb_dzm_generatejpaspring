...
public class Db2Column {
	...
	public Db2Column (String name, String tbname, String tbcreator, int colno, String coltype,
	...
	public static ArrayList<Db2Column> read (String tbcreator, String tbname) {
	...
	public static ArrayList<Db2Column> read (String tbcreator, String tbname, int keyseq) {
	...
	private static ArrayList<Db2Column> processResultSet (ResultSet rs) throws SQLException {
		ArrayList<Db2Column> list		= new ArrayList<Db2Column>();
		while (rs.next()) {
			list.add (new Db2Column	( rs.getString(1)
										, rs.getString(2)
										, rs.getString(3)
										, rs.getInt(4)
										, rs.getString(5)
